...
import '../layouts/item_obtained_marks.dart';

class ScreenCalucuateGpa extends StatelessWidget {
  const ScreenCalucuateGpa({Key? key}) : super(key: key);
